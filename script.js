    ...
    if (isAffordable(cost)) {
        ...
        if (name === 'Skepticism') {
            showMessageModal('The Journey Continues',
                "This marks the end of v0.9293. You've not only completed the Power Saga, but you're also getting the hang of Infinite Embraces and Meditations! Congratulations on your progress, and welcome to the next stage of your journey. "
