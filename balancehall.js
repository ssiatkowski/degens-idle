...
let balanceHallSkills = new Map([
    ...
    ["Everlasting Love", { description: "Pasively generate Love Points based on largest embrace each hour (online & offline) -- can go beyond the Infinite Embrace 1M limit", cost: { 'Troll Points': 1e225 }, available: false, unlocked: false }],
