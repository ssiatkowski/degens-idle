...
var zones = [
  {
    ...
    tasks: [
      { id: 11, name: "Warm-Up Jog in Place", type: "Training", maxReps: 10, count: 0, baseTime: 6e3, description: "Boost your stamina with a simple jog.", skills: ["endurance"] },
      ...
      { id: 17, name: "Small Talk Practice", type: "Training", maxReps: 5, count: 0, baseTime: 3e3, description: "Polish your social skills with casual chat.", skills: ["charisma"], mandatory: true },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 22, name: "Spot the Details", type: "Training", maxReps: 8, count: 0, baseTime: 2e3, description: "Sharpen your senses by noticing urban subtleties.", skills: ["perception"], mandatory: true },
      { id: 23, name: "Combined Recall Drill", type: "Training", maxReps: 6, count: 0, baseTime: 9e3, description: "Run while recalling facts about your surroundings.", skills: ["endurance", "intellect"] },
      { id: 24, name: "Assemble a Magnifying Glass", type: "Training", maxReps: 20, count: 0, baseTime: 5e3, description: "Assemble a simple magnifying glass.", skills: ["tinkering"], resources: ["magnifying_glass"] },
      { id: 25, name: "Strike up a Quick Chat", type: "Training", maxReps: 2, count: 0, baseTime: 6e3, description: "Engage strangers in conversation.", skills: ["charisma"] },
      { id: 26, name: "Healthy Living: Explore Dietary Options", type: "Training", maxReps: 3, count: 0, baseTime: 6e5, description: "Learn about healthy eating habits.", skills: ["perception", "endurance", "intellect", "alchemy"], perk: "healthy_living" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 32, name: "Basic Mech: Rudimentary Upgrade", type: "Training", maxReps: 1, count: 0, baseTime: 4e5, description: "Construct a basic biomechanical upgrade.", skills: ["tinkering", "mechanics", "intellect"], perk: "basic_mech" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 42, name: "Workaholic: Fiance Bro Advice", type: "Training", maxReps: 1, count: 0, baseTime: 1e7, description: "Learn how workaholics function.", skills: ["intellect", "endurance", "charisma", "perception"], perk: "workaholic" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 54, name: "Double Timer: System Revamp", type: "Training", maxReps: 2, count: 0, baseTime: 5e8, description: "Revamp a digital system to double its efficiency.", skills: ["hacking", "tinkering", "endurance", "intellect", "mechanics"], perk: "double_timer" },
      { id: 55, name: "Travel: Proceed to Combat Arena", type: "Travel", maxReps: 1, count: 0, baseTime: 5e4, description: "Step into the arena of combat.", skills: ["travel"] }
    ]
  },
  {
    id: 6,
    ...
    tasks: [
      ...
      { id: 63, name: "Tactical Coordination Group Skirmish", type: "Training", maxReps: 2, count: 0, baseTime: 1e8, description: "Develop team-based combat strategies.", skills: ["combat", "charisma", "endurance"] },
  ...
  },
  {
    ...
    tasks: [
      { id: 71, name: "Neural Implant Test", type: "Training", maxReps: 10, count: 0, baseTime: 1e5, description: "Test cutting-edge neural implants.", skills: ["cybernetics"] },
      { id: 72, name: "Exosuit Upgrade Overhaul", type: "Training", maxReps: 10, count: 0, baseTime: 3e7, description: "Upgrade your cybernetic exosuit.", skills: ["cybernetics", "mechanics"], mandatory: true },
      { id: 73, name: "System Calibration Diagnostic Run", type: "Training", maxReps: 5, count: 0, baseTime: 5e7, description: "Calibrate cybernetic systems.", skills: ["cybernetics", "tinkering"] },
      { id: 74, name: "Travel: Proceed to Rooftop Rendezvous", type: "Travel", maxReps: 1, count: 0, baseTime: 3e5, description: "Climb to the city rooftop.", skills: ["travel"] }
    ]
  },
  {
    id: 8,
    ...
    tasks: [
      { id: 81, name: "Tactics Broker a Deal", type: "Training", maxReps: 10, count: 0, baseTime: 9e7, description: "Hone your negotiation skills in high places.", skills: ["negotiation", "charisma"] },
      { id: 82, name: "High-Rise Debate Persuade the Crowd", type: "Training", maxReps: 10, count: 0, baseTime: 2e9, description: "Use your wit to sway opinions.", skills: ["negotiation", "charisma", "intellect"] },
      { id: 83, name: "Travel: Descend to Digital Underground", type: "Travel", maxReps: 1, count: 0, baseTime: 1e6, description: "Head back into the digital depths.", skills: ["travel"] }
    ]
  },
  {
    id: 9,
