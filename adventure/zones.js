...
var zones = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 35, name: "Assemble Goggles", type: "Training", maxReps: 12, count: 0, baseTime: 1.5e5, description: "Build yourself some eye protection.", skills: ["tinkering"], resources: ["goggles"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 57, name: "Noob Haxor: Study the Basics", type: "Training", maxReps: 1, count: 0, baseTime: 1e8, description: "Study the basics of hacking.", skills: ["hacking", "perception"], perk: "noob_haxor" },
      { id: 58, name: "Battle Shao Kahn", type: "Training", maxReps: 1, count: 0, baseTime: 1.5e8, description: "Some clown challenges you to mortal combat.", skills: ["combat"], boss_image: "images/shao_kahn.jpg", drainMult: 4, resources: ["shiny_helmet"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 96, name: "Battle Isshin", type: "Training", maxReps: 1, count: 0, baseTime: 1e10, description: "Challenge the master of the blade.", skills: ["combat"], boss_image: "images/isshin.jpg", drainMult: 20, resources: ["katana"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 106, name: "Battle Kratos", type: "Training", maxReps: 1, count: 0, baseTime: 5e10, description: "Challenge the demi-god.", skills: ["combat"], boss_image: "images/kratos.jpg", drainMult: 30, resources: ["blades_of_chaos"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 116, name: "Find Map to Forsaken Bastion", type: "Training", maxReps: 5, count: 0, baseTime: 1e14, description: "Find a map to the forsaken bastion.", skills: ["perception", "endurance"], mandatory: true},
      { id: 117, name: "Quantum Vitalizer: Energy Galore", type: "Training", maxReps: 1, count: 0, baseTime: 1e6, description: "Create a quantum vitalizer for health benefits.", skills: ["quantum"], perk: "quantum_vitalizer" },
      { id: 118, name: "Hyperlink Manipulation", type: "Training", maxReps: 7, count: 0, baseTime: 1e14, description: "A high-tech take on social engineering.", skills: ["cybernetics","charisma"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 123, name: "Neural Matrix: System Repair", type: "Training", maxReps: 5, count: 0, baseTime: 1e13, description: "Repair and optimize atomic systems.", skills: ["aiMastery", "hacking"], perk: "neural_matrix" },
      ...
      { id: 127, name: "Battle Deadpool", type: "Training", maxReps: 1, count: 0, baseTime: 2e11, description: "Challenge the merc with a mouth.", skills: ["combat"], boss_image: "images/deadpool.jpg", drainMult: 40, resources: ["beating_heart"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 134, name: "Produce Augment Fuel", type: "Training", maxReps: 4, count: 0, baseTime: 1e18, description: "Synethesize some augment fuel.", skills: ["cybernetics", "mechanics"], resources: ["augment_fuel"] },
      { id: 135, name: "Wise Mechanic: Knowledge Expansion", type: "Training", maxReps: 1, count: 0, baseTime: 1e22, description: "Expand your knowledge of mechanics.", skills: ["tinkering", "intellect", "mechanics"], perk: "wise_mechanic" },
      { id: 136, name: "Battle Vegeta", type: "Training", maxReps: 1, count: 0, baseTime: 1e12, description: "Challenge the prince of all Saiyans.", skills: ["combat"], boss_image: "images/vegeta.jpg", drainMult: 50, resources: ["saiyan_armor"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 143, name: "Prepare Hoverboard Fuel", type: "Training", maxReps: 16, count: 0, baseTime: 1e20, description: "Synthesize some fuel for your hoverboard.", skills: ["tinkering", "alchemy"], resources: ["hoverboard_fuel"] },
      { id: 143, name: "City Grid Optimization Neural Sync", type: "Training", maxReps: 5, count: 0, baseTime: 1e16, description: "Optimize urban networks with quantum precision.", skills: ["quantum", "intellect"], mandatory: true },
      { id: 144, name: "Corporate Espionage Information Heist", type: "Training", maxReps: 2, count: 0, baseTime: 3e17, description: "Steal confidential data using your omniscient insight.", skills: ["negotiation", "hacking"], mandatory: true },
      { id: 145, name: "Cryto Wallet: Find on Street", type: "Training", maxReps: 1, count: 0, baseTime: 1e12, description: "Find a lost crypto wallet.", skills: ["perception"], perk: "crypto_wallet" },
      { id: 146, name: "Challenge Big Brother", type: "Training", maxReps: 1, count: 0, baseTime: 1e13, description: "Challenge Big Brother.", skills: ["combat"], boss_image: "images/big_brother.jpg", drainMult: 55, resources: ["surveillance_core"] },
  ...
  },
  {
    ...
    tasks: [
      { id: 152, name: "Master of AI: Ultimate Challenge", type: "Training", maxReps: 5, count: 0, baseTime: 1e19, description: "Solve a complex algorithm that tests your intellect.", skills: ["aiMastery", "intellect"], perk: "master_of_ai" },
      { id: 153, name: "Mainframe Break-In Digital Siege", type: "Training", maxReps: 2, count: 0, baseTime: 5e19, description: "Penetrate a heavily fortified digital fortress.", skills: ["cybernetics", "mechanics"], mandatory: true },
      { id: 154, name: "Last Stand: Test of Endurance", type: "Training", maxReps: 5, count: 0, baseTime: 1e14, description: "Withstand an endless onslaught of foes.", skills: ["endurance"], perk: "last_stand" },
      { id: 155, name: "Puzzle Piece: Destiny", type: "Training", maxReps: 10, count: 0, baseTime: 1e17, description: "Find a piece of the ultimate puzzle to shape your destiny.", skills: ["aiMastery", "perception"], resources: ["puzzle_piece"]},
      { id: 156, name: "Cyber Siege Digital Onslaught", type: "Training", maxReps: 10, count: 0, baseTime: 2e18, description: "Launch a final digital assault on enemy systems.", skills: ["hacking", "cybernetics"], mandatory: true },
      { id: 157, name: "Discover Serenity", type: "Prestige", maxReps: 1, count: 0, baseTime: 1e6, description: "Find inner peace and serenity.", skills: ["omniscience"], mandatory: true },
      { id: 158, name: "Travel: Enter the Victory Chamber", type: "Travel", maxReps: 1, count: 0, baseTime: 1e10, description: "Step into the chamber of ultimate triumph.", skills: ["travel"] }
    ]
  }
];
